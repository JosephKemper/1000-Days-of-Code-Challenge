...
def main():
    try:
        ...
        print(f"The file {filename} doesn't exist.")  # type: ignore
        ...
        print(f"You don't have permission to read {filename}.")  # type: ignore
        ...
        if linenum < 0:  # type: ignore
            ...
            print(f"{linenum} is greater than the number" + f" of lines in {filename}.")  # type: ignore
            print(f"There are only {length} lines in {filename}.")  # type: ignore
