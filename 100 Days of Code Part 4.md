...
I got a little discouraged with my lack of progress, and because of battling with some personal problems. Both of those have been dealt with now and I am back at it again. I have a new plan built for going forward and already started on the plan. I built a simple counter app, the app has two working buttons, one that increases the count displayed by 1 and one that resets the count back to 0. The count button will increase the count from 0 to 999 and will then reset back to 0 and start over again. Now, I plan to release that app on the Google Play Store, and will then start working on my next project. I have no idea how long it will take me to figure out how to release an app to the Google Play Store. I already have the needed account set up, but I imagine I will still need to figure a few things out. My app will be add free and will be sold for 99 cents. I will also need to get my company site up and running and get a way for potential customers to contact me, but I at least have a product to start with. 
